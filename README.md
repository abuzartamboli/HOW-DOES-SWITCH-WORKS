...
# Step 4:- And now we will check the PCS that the PC0 and PC1 has configured or not through packet sharing
<img width="1887" height="946" alt="Screenshot 2026-08-10 225926" src="https://github.com/user-attachments/assets/3f0d73de-41a4-4200-9d9a-03f93cf8b6c1" />

# Now you will the PCS are configured and packet sharing are being successfull 
...
# Through this project, I gained a practical understanding of MAC addresses, MAC address learning, frame forwarding, flooding, LAN communication, and switch ports. This knowledge provides a strong foundation for further learning in Networking and Cybersecurity.
